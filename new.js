...
////////////////////////////////////////////////////////////////////////////////
var tweets = JSON.parse(fs.readFileSync('test_tweets1.json', 'utf8'));
...
//     if (flags[tweets[i].id]) continue;
//     flags[tweets[i].id] = true;
//     output.push(tweets[i]);
// }

// fs.appendFile("test_tweets1.json", JSON.stringify(output), function(err) {
//     if(err) {
